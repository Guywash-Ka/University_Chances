...
'Фундаментальная информатика и информационные технологии': ['Математика', 'Русский язык', 'Информатика и ИКТ'],
...
questions_for_math = ['Павел Иванович купил американский автомобиль, на спидометре которого скорость измеряется в милях в час. Американская миля равна 1609 м. Какова скорость автомобиля в километрах в час, если спидометр показывает 50 миль в час? Ответ округлите до целого числа.',
...
correct_answers_dict = {'Математика': ['80', '3150000', '20', '0,08', '-10', '1,5', '6', '2', '2', '10', '12', '-17'], 'Русский язык':[str(i) for i in range(38)], 'Информатика и ИКТ': [str(i) for i in range(23)],
    'Обществознание': [str(i) for i in range(20)], 'История': [str(i) for i in range(20)], 'Иностранный язык': [str(i) for i in range(20)], 'Физика': [str(i) for i in range(20)]}