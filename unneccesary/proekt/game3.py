...
images = {
    'start_thing': image.load('start_thing.png'),
    'background': image.load('background_strip.png'),
    'ground': image.load('ground.png'),
    'pole': image.load('pole.png'),
    'score_board': image.load('score_board.png')
    }
...
class Flappy_Class:
    ...
    def __init__(self):
        ...
        self.flap_1 = transform.scale(image.load('flap_1.png'), (self.width, self.height))
        self.flap_2 = transform.scale(image.load('flap_2.png'), (self.width, self.height))
        self.flap_3 = transform.scale(image.load('flap_3.png'), (self.width, self.height))
