...
background = image.load('proekt/data/fon1.jpg')
...
def boom():
	# звук выстрела
    file = os.path.join('proekt/data', 'vistrel.wav')
...
#------------------------------------------------------------
pstr1 = Sprite (zx,zy, 'proekt/data/pstr01.png') 
pstr2 = Sprite (zx,zy, 'proekt/data/pstr02.png')
pstr3 = Sprite (zx,zy, 'proekt/data/pstr03.png')
pstl1 = Sprite (zx,zy, 'proekt/data/pstl01.png') 
pstl2 = Sprite (zx,zy, 'proekt/data/pstl02.png')
pstl3 = Sprite (zx,zy, 'proekt/data/pstl03.png')
...
class Pistol(Sprite):
    def __init__(self, xpos, ypos, naprav):
        ...
        if naprav == 'right':
            ...
            pst2 = pstr2
            pst3 = pstr3
            pst1 = Sprite.__init__(self,xpos,ypos, 'proekt/data/pstr01.png') 
        else:
            # Дуло смотрит влево	
            pst1 = pstl1 
            pst2 = pstl2
            pst3 = pstl3
            pst1 = Sprite.__init__(self,xpos,ypos, 'proekt/data/pstl01.png') 
...
class Vrag(Sprite):
	def __init__(self,xpos,ypos,naprav):
		...
		self.y = ypos
		if naprav == 'left':
		 	  vrg = Sprite.__init__(self,xpos,ypos, 'proekt/data/botr1.bmp')
		else:
		  	  
			  vrg = Sprite.__init__(self,xpos,ypos, 'proekt/data/botl1.bmp')
